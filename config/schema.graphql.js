  ...
  resolver: {
    Query: {
      ...
      role: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.userspermissions.getRole(context);
      ...
      roles: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.userspermissions.getRoles(context);
    ...
    Mutation: {
      createRole: {
        ...
        resolver: async (obj, options, { context }) => {
          await siapi.plugins['users-permissions'].controllers.userspermissions.createRole(
            context
          );
      ...
      updateRole: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.userspermissions.updateRole(
            context
          );
      ...
      deleteRole: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.userspermissions.deleteRole(
            context
          );
      ...
      createUser: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.user.create(context);
      ...
      updateUser: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.user.update(context);
      ...
      deleteUser: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.user.findOne(context);
          // Assign result to user.
          const user = context.body.toJSON ? context.body.toJSON() : context.body;

          // Run destroy query.
          await siapi.plugins['users-permissions'].controllers.user.destroy(context);
      ...
      register: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.auth.register(context);
      ...
      login: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.auth.callback(context);
          let output = context.body.toJSON ? context.body.toJSON() : context.body;
      ...
      forgotPassword: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.auth.forgotPassword(context);
          let output = context.body.toJSON ? context.body.toJSON() : context.body;
      ...
      resetPassword: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.auth.resetPassword(context);
          let output = context.body.toJSON ? context.body.toJSON() : context.body;
      ...
      emailConfirmation: {
        ...
        resolver: async (obj, options, { context }) => {
          ...
          await siapi.plugins['users-permissions'].controllers.auth.emailConfirmation(
            context,
            null,
            true
          );
